...
function UnitCell(basis::AbstractVector{<:AbstractVector{Float64}}, primitive_vectors::AbstractVector{<:AbstractVector{Float64}}, bonds::AbstractVector{Bond}; site_colors::AbstractVector{Int}=ones(Int, length(basis)))
